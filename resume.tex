...
\begin{itemize}
  \item Conduct user research on cross boarder payment, provide user requirements analysis by interviewing 30 potential users
  \item Model risk score with social-network profiles by Klout, Linkedin and Facebook to replace KYC process
  \item Build ERC-20 token based on Ethereum
\end{itemize}
